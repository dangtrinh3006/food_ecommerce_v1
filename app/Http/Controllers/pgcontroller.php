...
class pgcontroller extends Controller
{
    ...
    public function postLienHe(Request $req){
        ...
        $tile_mail = "Liên Hệ từ GoodFood".' '.$now;
    ...
    public function information_policy(Request $req){
        $image_og = $req->url();

        return view('FrontEnd.InformationPolicy', compact('image_og'));
    }

    public function payment_policy(Request $req){
        $image_og = $req->url();

        return view('FrontEnd.PaymentPolicy', compact('image_og'));
    }

    public function delivery_policy(Request $req){
        $image_og = $req->url();

        return view('FrontEnd.DeliveryPolicy', compact('image_og'));
    }
