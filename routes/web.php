...
Route::post('passwordUpdate',['as'=>'passwordUpdate','uses'=>'TaiKhoan_Controller@passwordUpdate']);
...
// Order
Route::get('/lich-su-don-hang','ordercontroller@history');
Route::get('don-hang-chi-tiet/{id}',['as'=>'chitietdonhang','uses'=>'ordercontroller@getDonhangchitiet']);
Route::get('canceldh/{id}',['as'=>'canceldh','uses'=>'ordercontroller@Cancel_DonHang']);
Route::get('updatedh/{id}',['as'=>'updatedh','uses'=>'ordercontroller@Update_DonHang']);

// Policies
Route::get('/Information-Policy','pgcontroller@information_policy');
Route::get('/Payment-Policy','pgcontroller@payment_policy');
Route::get('/Delivery-Policy','pgcontroller@delivery_policy');
