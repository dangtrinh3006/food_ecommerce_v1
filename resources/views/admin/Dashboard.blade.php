    ...
    <div class="row">
        ...
        <div class="col-xl-8 col-lg-7">
            <div class="card shadow mb-4">
                ...
                <div
                    ...
                    <h6 class="m-0 font-weight-bold text-danger">{{ trans('home_ad.thongke_dh') }} </h6>
                ...
                <div class="card-header py-3 d-flex flex-row align-items-center justify-content-between">
                        ...
                        <p><input style="margin-top: 22px;" type="button" id="btn-dashboard" class="btn btn-danger btn-sm" value="{{ trans('home_ad.lockq') }}"></p>
                </div>
                </form>
                <!-- Card Body -->
        ...
        <div class="col-xl-4 col-lg-5">
            <div class="card shadow mb-4">
                ...
                <div
                    class="card-header py-3 d-flex flex-row align-items-center justify-content-between">
                    <h6 class="m-0 font-weight-bold text-success">{{ trans('home_ad.thongke') }}</h6>
                    <div class="dropdown no-arrow">
                        <a class="dropdown-toggle" href="#" role="button" id="dropdownMenuLink"
                            data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                            <i class="fas fa-ellipsis-v fa-sm fa-fw text-gray-400"></i>
        ...
        <div class="col-lg-6 mb-4">
            ...
            <div class="card shadow mb-4">
                <div class="card-header py-3">
                    <h6 class="m-0 font-weight-bold text-sucess">{{ trans('home_ad.thongke_trc') }}</h6>
                </div>
                <div class="card-body">
