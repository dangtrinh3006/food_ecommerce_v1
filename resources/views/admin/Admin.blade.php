    ...
    <div id="wrapper">
        ...
        <ul class="navbar-nav bg-gradient-danger  sidebar sidebar-dark accordion" id="accordionSidebar">
            ...
            <a class="sidebar-brand d-flex align-items-center justify-content-center" href="{{route('trang-chu-admin')}}">
                ...
                <div class="sidebar-brand-text mx-3">GOOD FOOD MANAGER</div>
            </a>
            ...
            <footer class="sticky-footer bg-white">
                <div class="container my-auto">
                    <div class="copyright text-center my-auto">
                        <span>Copyright &copy; GoodFood 2021</span>
                    </div>
                </div>
            </footer>
            <!-- End of Footer -->
   ...
   <script type="text/javascript">
    ...
    <script type="text/javascript">
        ...
        @if(session('thongbaoloi'))
            ...
            toastr.warning('{{ session('thongbaoloi') }}', '{{trans('home.Notification')}}',{timeOut: 7000});
