                                            ...
                                            <div class="modal-body">
                                                ...
                                                <div class="form-group" style="font-weight: bold; color: #000">
                                                    ...
                                                    <select name="level" class="form-control">
                                                        ...
                                                        <option <?php if($usr->level==2)echo 'selected' ?> value="2">Người dùng</option>
                                                        <option <?php if($usr->level==3)echo 'selected' ?> value="3">Nhân viên</option>
                                                        <option <?php if($usr->level==4)echo 'selected' ?> value="3">Quản lý</option>
                                                    </select>
                                                </div>
