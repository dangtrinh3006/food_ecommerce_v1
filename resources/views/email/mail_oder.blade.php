                                ...
                                <tr>
                                    <td align="left" valign="middle" style="width:500px;height:60px">
                                        <a href="{{route('trang-chu')}}" style="border:0" target="_blank" width="130" height="35" style="display:block;border:0px">
                                            <img src="{{asset('source/assets/dest/images/logo_gf_2.png')}}" height="110px" width="155px" style="display:block;border:0px;float: left;"> <b style="float: left;line-height: 100px;color: red;font-size: 20px;"></b>
                                        </a>
                                    </td>
                                    {{-- Fix --}}
                                    {{-- <td align="right" valign="middle" style="padding-right:15px">
                                        <a href="" style="border:0"> 
                                            <img src="{{asset('source/assets/dest/images/logo_gf_2.png')}}" height="36" width="115" style="display:block;border:0px"> 
                                        </a>
                                    </td> --}}
                                </tr>
                            </tbody>
                            ...
                            <tbody>
                                ...
                                <tr>
                                    <td align="left" valign="middle" style="font-family:Arial,Helvetica,sans-serif;font-size:12px;color:#666666;padding:0 10px 20px 10px;line-height:17px">
                                        ...
                                        <br> Cảm ơn bạn đã mua sắm tại GoodFood
                                        <br>
                                        <br> Đơn hàng của bạn đang 
                                        <b>chờ được chờ</b>  
                                        <b>xác nhận</b> 
                                        <br> Chúng tôi sẽ cập nhật <b>trạng thái đơn hàng</b> khi được duyệt thành công.
                                        <br> Bạn vui lòng kiểm tra lịch sử đơn hàng nhé!
                                        <br> Xin cảm ơn!
                                        <br> From <b>GoodFood</b>
                                    </td>
                                </tr>
                            </tbody>
                        </table>
                                            ...
                                            <table style="width:100%" cellpadding="0" cellspacing="0" border="0">
                                                <tbody>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td align="left" valign="top" style="font-family:Arial,Helvetica,sans-serif;font-size:12px;color:#666666;line-height:20px;padding-bottom:5px">:</td>
                                                        <td align="left" valign="top" style="font-family:Arial,Helvetica,sans-serif;font-size:12px;color:#666666;line-height:20px;padding-left:10px;padding-bottom:5px">                            {{$shipping_array['address']}}
                                                        </td>
                                                    </tr>
                                                </tbody>
                                            </table>
