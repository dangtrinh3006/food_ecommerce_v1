                        ...
                        <table>
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <input type="number" name="product_quantity_order" value="{{$cart['qty']}}" min="1" style="width: 40px; text-align: center;">
                          

                        
                                    <!-- <button >Cập nhật</button>                                    </td> -->
                                        ...
                                        <tr class="order-total">
                                            ...
                                            <td>
                                                <strong>
                                                	<span class="amount">
                                                		@if(Session('cart'))
															{{number_format($totalPrice + 30000,0,',','.')}} VNĐ
														@else
															0 VNĐ
														@endif</span>
												</strong>
