...
<header>
    ...
    <!--  Modal-->
    @extends('dk-dn-dx/thongtin') @section('content-tt') @endsection
    ...
    <div class="header-top-area">
        <div class="container">
            ...
            <div class="header-top">
                <ul>
                    <li><a href="#">{{trans('home.intro')}}</a></li>
                ...
                <ul>                                          
                    ...
                    <li>
                        <!-- 
                        <a href="https://www.facebook.com/dangtrinh3006">{{ trans('home.hi') }}, 
                        ...
                        <a class="nav-link dropdown-toggle" href="#" id="userDropdown" role="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                                <span class="mr-2 d-none d-lg-inline text-gray-600 small" style="color:red">
                                    @if(Auth::check() && Auth::user()->level == 1)
                                    Hi, Admin {{Auth::user()->full_name}}
                                    @endif
                                    @if(Auth::check() && Auth::user()->level == 3)
                                    Hi, Nhân Viên {{Auth::user()->full_name}}
                                    @endif
                                    @if(Auth::check() && Auth::user()->level == 2)
                                        Hi, Khách Hàng {{Auth::user()->full_name}}
                                    @endif
                                    @if(Auth::check() && Auth::user()->level == 4)
                                        Hi, Quản lý {{Auth::user()->full_name}}
                                    @endif
                                </span>
                                <img src="https://img.icons8.com/bubbles/50/000000/user.png"/>                            </a>
                            <!-- Dropdown - User Information -->
                            <div class="dropdown-menu dropdown-menu-right shadow animated--grow-in" aria-labelledby="userDropdown">
                                <a class="dropdown-item" href="#" data-toggle="modal" data-target="#userUpdate">
                                    <i class="fas fa-list fa-sm fa-fw mr-2 text-gray-400"></i> {{ trans('home.account_information') }}
                                </a>
                                <a class="dropdown-item" href="#" data-toggle="modal" data-target="#passwordUpdate">
                                    <i class="fas fa-list fa-sm fa-fw mr-2 text-gray-400"></i> {{ trans('home.change_password') }}
                                </a>
                    ...
                    @elseif(Auth::user()->level == 1 || Auth::user()->level == 3 || Auth::user()->level == 4)
                    <li><a href="{{route('trang-chu-admin')}}">Quản trị</a></li>
                    @endif
                    @else
            ...
            <div class="row align-items-center no-gutters">
                <div class="col-lg-3 col-md-12">
                    <div class="logo mb-all-30">
                        {{-- Logo web --}}
                        <a href="{{route('trang-chu')}}"><img src="{{asset('source/assets/dest/images/logo_gf_2.png')}}" style="width: 200px; height: 200px" alt="logo-image"></a>
                    </div>
                </div>
                ...
                <div class="col-lg-4 col-md-12">
                    <div class="cart-box mt-all-30">
                        <ul class="d-flex justify-content-lg-end justify-content-center align-items-center">
                            {{-- icon history --}}
                            @php
                                $customer_id = Session::get('user_id_login');
                                if($customer_id != Null){
                                @endphp
                                <li>
                                    ...
                                    <span >
                                        <span class="total-pro"></span>
                                        <span>{{trans('home.historyyy')}}</span>
                                    </span>
                                    </a>
                                </li>
                                @php
